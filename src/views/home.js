    ...
    <div className="home-container">
        ...
        <div className="home-container11">
          <div className="home-container12">
            <div className="home-container13">
              <h2 className="home-text08 HeadingOne">Work with us</h2>
              <p className="home-text09 Lead">
              ...
              <p className="home-text11">-Creator</p>
            </div>
          </div>
      ...
      <section className="home-contaier">
        <div className="home-container26">
          ...
          <h2 className="home-text12 HeadingTwo">
            <span className="home-text13">Beware The Components</span>
          </h2>
          <h3 className="home-text14 HeadingTwo">
            <span className="home-text15">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home-container28">
          <div className="home-container29">
            ...
            <div className="home-container31">
              ...
              <h1 className="home-text18 HeadingOne">Viewers!</h1>
              <span className="home-text19">Website moderator</span>
              <Link to="/job-mod" className="home-navlink5">
                <OutlineBlackButton
        ...
        <div className="home-container33">
          ...
          <div className="home-container35">
            ...
            <div className="home-container37">
              ...
              <span className="home-text23">FOR FREE</span>
      ...
      <footer className="home-footer">
        <div className="home-container38">
          <div className="home-container39">
            <span className="home-text24">SOFT</span>
            <span>Copyright © 2022  by Gamesplus.</span>
          </div>
          <div className="home-container40">
            <div className="home-container41">
              <span className="home-text26 Large">Company</span>
              <a href="#About" className="home-link Large">
                About Us
              </a>
              <Link to="/job-mod" className="home-navlink7 Large">
                Careers
              </Link>
              <Link to="/" className="home-text27 Large">
                Press
              </Link>
            </div>
            <div className="home-container42">
              <span className="home-text28 Large">Pages</span>
              <span className="home-text29 Large">Login</span>
              <span className="home-text30 Large">Register</span>
              <span className="home-text31 Large">About</span>
            </div>
            <div className="home-container43">
              <span className="home-text32 Large">Products</span>
              <span className="home-text33 Large">Free</span>
              <span className="home-text34 Large">PRO</span>
              <span className="home-text35 Large">Latest</span>
            </div>
          </div>
        </div>
        <img
