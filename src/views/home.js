      ...
      <footer className="home-footer">
        <div className="home-container32">
          <div className="home-container33">
            <span className="home-text30">SOFT</span>
            <span>Copyright © 2022  by Gamesplus.</span>
          </div>
          <div className="home-container34">
            <div className="home-container35">
              <span className="home-text32 Large">Company</span>
              ...
              <Link to="/" className="home-text33 Large">
                Press
              </Link>
            </div>
            <div className="home-container36">
              <span className="home-text34 Large">Pages</span>
              <span className="home-text35 Large">Login</span>
              <span className="home-text36 Large">Register</span>
              <span className="home-text37 Large">About</span>
            </div>
            <div className="home-container37">
              <span className="home-text38 Large">Products</span>
              <span className="home-text39 Large">Free</span>
              <span className="home-text40 Large">PRO</span>
              <span className="home-text41 Large">Latest</span>
            </div>
          </div>
        </div>
        <img
