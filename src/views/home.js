    ...
    <div className="home-container">
      ...
      <section className="home-contaier">
        <div className="home-container28">
          ...
          <h2 className="home-text10 HeadingTwo">
            <span className="home-text11">Beware The Components</span>
          </h2>
          <h3 className="home-text12 HeadingTwo">
            <span className="home-text13">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home-container30">
          <div className="home-container31">
            ...
            <div className="home-container33">
              ...
              <h1 className="home-text16 HeadingOne">Viewers!</h1>
              <span className="home-text17">Website moderator</span>
          ...
          <div className="home-container34">
            <div className="home-container35">
              <h5 className="home-text18">1. Have more practice</h5>
              <span className="home-text19">
                If you have more experience you are more likely to be selected. 
              </span>
            </div>
            <div className="home-container36">
              <h5 className="home-text20">2. Be consistent  </h5>
              <span className="home-text21">
                If you get it always check up!
              </span>
            </div>
            <div className="home-container37">
              <h5 className="home-text22">3. Be nice</h5>
        ...
        <div className="home-container38">
          ...
          <div className="home-container40">
            ...
            <div className="home-container42">
              ...
              <Link to="/e-m-a-i-l" className="home-navlink7">
                <OutlineBlackButton
                  GetGaming="get started"
      ...
      <footer className="home-footer">
        <div className="home-container43">
          <div className="home-container44">
            <span className="home-text27">SOFT</span>
            <span>Copyright © 2022  by Gamesplus.</span>
          </div>
          <div className="home-container45">
            <div className="home-container46">
              <span className="home-text29 Large">Company</span>
              ...
              <Link to="/" className="home-text30 Large">
                Press
              </Link>
            </div>
            <div className="home-container47">
              <span className="home-text31 Large">Pages</span>
              <span className="home-text32 Large">Login</span>
              <span className="home-text33 Large">Register</span>
              <span className="home-text34 Large">About</span>
            </div>
            <div className="home-container48">
              <span className="home-text35 Large">Products</span>
              <span className="home-text36 Large">Free</span>
              <span className="home-text37 Large">PRO</span>
              <span className="home-text38 Large">Latest</span>
            </div>
          </div>
        </div>
        <img
