    ...
    <div className="home-container">
      ...
      <section className="home-contaier">
        <div className="home-container28">
          ...
          <h2 className="home-text10">Compatition</h2>
        ...
        <div className="home-container30">
          <div className="home-container31">
            ...
            <div className="home-container33">
              ...
              <h1 className="home-text14 HeadingOne">Viewers!</h1>
              <span className="home-text15">Website moderator</span>
          ...
          <div className="home-container34">
            <div className="home-container35">
              <h5 className="home-text16">1. Have more practice</h5>
              <span className="home-text17">
                If you have more experience you are more likely to be selected. 
              </span>
            </div>
            <div className="home-container36">
              <h5 className="home-text18">2. Be consistent  </h5>
              <span className="home-text19">
                If you get it always check up!
              </span>
            </div>
            <div className="home-container37">
              <h5 className="home-text20">3. Be nice</h5>
