...
const Home = (props) => {
  return (
    <div className="home-container">
        ...
        <div className="home-container01">
          <div id="About" className="home-card">
            ...
            <span className="home-text02 Lead">
              Why us? Well we do not want your cookies and never will. Also we
              hope you never ever get ads on our site so you can have unlimited
              play time!
            </span>
            <div className="home-container02">
              ...
              <Link to="/read-more" className="home-navlink4">
                <OutlineGrayButton
                  button="read more"
      ...
      />
      <Link to="/games" className="home-navlink5">
        <FeatureCard
        ...
        <div className="home-container11">
          <div className="home-container12">
            <div className="home-container13">
              ...
              <p className="home-text10">-Creator</p>
            </div>
          </div>
      ...
      <section className="home-contaier">
        <div className="home-container26">
          ...
          <h2 className="home-text11 HeadingTwo">
            <span className="home-text12">Beware The Components</span>
          </h2>
          <h3 className="home-text13 HeadingTwo">
            <span className="home-text14">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home-container28">
          <div className="home-container29">
            ...
            <div className="home-container31">
              ...
              <h1 className="home-text17 HeadingOne">Viewers!</h1>
              <span className="home-text18">Website moderator</span>
        ...
        <div className="home-container33">
          ...
          <div className="home-container35">
            ...
            <div className="home-container37">
              ...
              <h1 className="home-text19 HeadingOne">Talk and Meet!</h1>
      ...
      <footer className="home-footer">
        <div className="home-container38">
          <div className="home-container39">
            <span className="home-text23">SOFT</span>
            <span>Copyright © 2022  by Gamesplus.</span>
          </div>
          <div className="home-container40">
            <div className="home-container41">
              <span className="home-text25 Large">Company</span>
              ...
              <Link to="/" className="home-text26 Large">
                Press
              </Link>
            </div>
            <div className="home-container42">
              <span className="home-text27 Large">Pages</span>
              <span className="home-text28 Large">Login</span>
              <span className="home-text29 Large">Register</span>
              <span className="home-text30 Large">About</span>
            </div>
            <div className="home-container43">
              <span className="home-text31 Large">Products</span>
              <span className="home-text32 Large">Free</span>
              <span className="home-text33 Large">PRO</span>
              <span className="home-text34 Large">Latest</span>
            </div>
          </div>
        </div>
        <img
